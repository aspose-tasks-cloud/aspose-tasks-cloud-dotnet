...
{
	/// <summary>
	/// Wrapper class for Aspose.Tasks Cloud Tools context access to Pages and controls
	/// </summary>
	public class AsposeTasksCloudContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeTasksCloudContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeTasksCloudContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeTasksCloudContext atcc { set { atc = value; } }
		internal static AsposeTasksCloudContext Current
		{
			get { return atc; }
		}
