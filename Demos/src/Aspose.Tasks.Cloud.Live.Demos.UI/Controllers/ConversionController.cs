using Aspose.Tasks.Cloud.Live.Demos.UI.Models.Common;
				...
				if (postedFile != null)
				{
					...
					if ((isFileUploaded != null) && (isFileUploaded.FileName.Trim() != ""))
					{
						AsposeTasksConversion asposeTasksConversion = new AsposeTasksConversion();
							 response = asposeTasksConversion.Convert(isFileUploaded.FileName, isFileUploaded.FolderId,   outputType.ToLower().Replace(" ", ""));
